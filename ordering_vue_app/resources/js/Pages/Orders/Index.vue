        ...
        <div class="py-12">
            ...
            <div class="m-3 max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <table class="table-auto border border-gray-400 w-100 m-3">
                        ...
                        <tbody>
                            <tr v-for="order in orders.data" :key="order.id">
                                ...
                                <td
                                    class="border border-gray-400 px-2 py-2 text-center text-xs"
                                >
                                    {{ order.orderday }}
                                </td>
                                ...
                                >
                                    <DangerButton
                                        @click="
                                            deleteOrder(order.id, order.name)
                                        "
                                    >
                    ...
                    <!-- Pagination -->
                    <nav
                        class="flex items-center gap-x-1 mt-2 mb-2"
